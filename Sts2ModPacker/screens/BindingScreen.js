  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={handleOpenHistory} style={styles.historyIcon}>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontWeight: 'bold', color: '#4A4043', flex: 1, textAlign: 'center', marginLeft: 40 },
  historyIcon: { position: 'absolute', right: 15, padding: 5 },
  imageCard: {
